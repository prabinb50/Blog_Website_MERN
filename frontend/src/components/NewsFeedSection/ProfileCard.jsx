...
export default function ProfileCard() {
  return (
    <div className="flex flex-col items-center justify-center bg-white  rounded-md gap-8 px-8 py-10">
            <div className="flex flex-col items-center justify-center gap-2 ">
              ...
              <p className="text-4xl font-semibold opacity-80">user name</p>
            </div>

            <p className="opacity-60 font-semibold leading-6 text-center text-sm tracking-wide">
